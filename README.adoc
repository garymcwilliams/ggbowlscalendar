= Bowls Calendar image:https://github.com/garymcwilliams/ggbowlscalendar/workflows/Python%20Coverage%20Workflow/badge.svg["Coverage", link="https://github.com/garymcwilliams/ggbowlscalendar/actions"]
