...
line 4: is the `starting date` for the league. All other matches are calculated from this base. NOTE: you should make this date be the "usual home day" for the team in this league, e.g. Wednesday for Belfast Zone.
